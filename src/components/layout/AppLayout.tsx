    ...
    return (
      <div className="min-h-screen flex items-center justify-center" style={{ background: 'var(--bg-base)' }}>
        <div className="flex flex-col items-center gap-4">
          <div className="w-12 h-12 rounded-2xl flex items-center justify-center animate-pulse" style={{ background: 'var(--kabu-maroon)' }}>
            <svg className="w-7 h-7" style={{ color: 'var(--text-inverse)' }} fill="none" stroke="currentColor" strokeWidth="2.5" viewBox="0 0 24 24">
